...
const (
	...
	WrongType         = "wrong estimation type, type should be normal or premium"
	MissingBaseAmount = "missing base amount parameter, base_amount is required"
	WrongBaseAmount   = "wrong base amount parameter, base_amount should be a real number"
